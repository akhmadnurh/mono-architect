  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3.5 top-1/2 z-30 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full border border-slate-700/80 bg-slate-900 text-slate-300 shadow-md transition-all hover:border-purple-500/50 hover:bg-slate-800 hover:text-slate-100"
      >
        {collapsed ? (
      ...
      <nav className="flex flex-col gap-1 px-2 py-3">
        ...
        >
          <Home className="mr-2.5 h-4 w-4 shrink-0 text-slate-400 group-hover:text-purple-400" />
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-3">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            {projects.map((p) => (
              ...
              >
                <span className="truncate max-w-[200px] font-medium text-slate-300 hover:text-slate-100 transition-colors">
                  {p.title}
                </span>
              </Link>
            ))}
        ...
        >
          ...
          {!collapsed && (
            <>
              ...
              <button
                onClick={() => signOut()}
                className="shrink-0 rounded p-1.5 text-white/40 transition-colors hover:bg-white/5 hover:text-white/80"
                title="Logout"
              >
